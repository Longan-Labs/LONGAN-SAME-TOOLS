...
const PinDescription g_APinDescription[]=
{
  ...
  { PORTB,  8, PIO_DIGITAL,   PIN_ATTR_NONE,  No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_8 },  // D4
  { PORTB,  9, PIO_DIGITAL,   PIN_ATTR_NONE,  No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_9 },  // D5
  ...
  { PORTB, 12, PIO_DIGITAL,   PIN_ATTR_PWM_G, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_12 }, // D8
  { PORTB, 13, PIO_DIGITAL,   PIN_ATTR_PWM_G, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_13 },   // D9
  ...
  { PORTA, 18, PIO_DIGITAL,   PIN_ATTR_PWM_F, No_ADC_Channel, TCC1_CH2,   NOT_ON_TIMER, EXTERNAL_INT_2 },  // D12 - I2C_INT
  { PORTB,  6, PIO_DIGITAL,   PIN_ATTR_NONE,  No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_6 }, // D13
  ...
  { PORTB,  8, PIO_ANALOG, PIN_ATTR_ANALOG,     ADC_Channel2,  NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_8 },   // A9
  { PORTB,  9, PIO_ANALOG, PIN_ATTR_ANALOG,     ADC_Channel3,  NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_9 },   // A10
  // -------------------------------------------------------------------------------------------------------------------------- 
  ...
  // 38..39
  // ---------------------------------------------------------------------------------------------------------------------
  { PORTB, 14, PIO_AC_CLK, PIN_ATTR_PWM_F, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_14 },             // CAN TXO
  { PORTB, 15, PIO_AC_CLK, PIN_ATTR_PWM_F, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_15 },             // CAN RXI
  // ---------------------------------------------------------------------------------------------------------------------
  ...
  // 40....44
  // ---------------------------------------------------------------------------------------------------------------------
  { PORTA, 21, PIO_DIGITAL, PIN_ATTR_PWM_F,   No_ADC_Channel, TCC0_CH1,   NOT_ON_TIMER,      EXTERNAL_INT_5 },    // SDO
  { PORTA, 22, PIO_DIGITAL, PIN_ATTR_PWM_F,   No_ADC_Channel, TCC0_CH2,   NOT_ON_TIMER,      EXTERNAL_INT_6 },    // SDI
  { PORTB, 16, PIO_DIGITAL, PIN_ATTR_PWM_G,   No_ADC_Channel, NOT_ON_PWM,   NOT_ON_TIMER,      EXTERNAL_INT_12 },   // SCK 
  { PORTB, 17, PIO_DIGITAL, PIN_ATTR_PWM_F,   No_ADC_Channel, NOT_ON_PWM,   NOT_ON_TIMER,      EXTERNAL_INT_12 },   // MCLK 
